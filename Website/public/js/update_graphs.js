...
{	
	var FLEXIBILITY = ["QUAD STRETCH","SHOULDER RAISES","NECK SIDE STRETCH","CHEST STRETCH","ARM RAISES"];
	var STRENGTH    = ["WALL PUSH-UP","TRICEP KICKBACKS","LATERAL RAISES","KNEE EXTENSION","CALF RAISES"];
	var CARDIO      = ["WALKING", "JOGGING", "JUMPING JACKS"];
	var BALANCE     = ["SINGLE LEG STANCE","SIDE LEG LIFT","KNEE MARCHING","HEEL TO TOE"];
